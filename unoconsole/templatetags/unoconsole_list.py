...
def items_for_result_csv(cl, result, form):
    """
    Generates the actual list of data.
    """
    first = True
...
def results_csv(cl):
    for res in cl.result_list:
        yield ResultList(None, items_for_result_csv(cl, res, None))

@register.inclusion_tag("unoconsole/change_list_results.html")
def result_list(cl):
    """
...
@register.inclusion_tag("unoconsole/change_list_results_csv.html")
def result_list_csv(cl):
    """
    Displays the headers and data list together
    """
    headers = list(result_headers_csv(cl))
    return {'cl': cl,
            'result_headers': headers,
            'results': list(results_csv(cl))}
...
@register.inclusion_tag('unoconsole/search_form.html')
def search_form(cl):
    """
...
@register.inclusion_tag('unoconsole/actions.html', takes_context=True)
